                ...
                <form class="registerform" action="" method="post">
                    <div id="register_box">
                        ...
                        <div class="input_zone">
                            ...
                            <div class="input_r">
                                <input class="user_name input_large_en" type="text" name="username" ajaxurl="/member/ajaxChkReg" datatype="m|e" nullmsg="请输入您的手机号或常用邮箱。" errormsg="请输入正确的邮箱或手机号。" id="username" value="手机注册更享好礼" style="color:#ccc;" />
                            </div>
                        ...
                        <div class="input_zone">
                            ...
                            <div class="input_r">
                                <input class="input_large_en" type="password" name="password" id="password" datatype="*6-16" nullmsg="密码不能为空，请输入密码。" errormsg="用户密码长度范围在6~16位之间。" />
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="input_zone">
                            <div class="input_l"><i>确认 密码：</i></div>
                            <div class="input_r">
                                <input class="input_large_en" type="password" name="password2" id="password2" recheck="password" datatype="*" nullmsg="请重新输入一次上面的密码。" errormsg="您两次输入的密码不一致。" />
                            </div>
                            <div class="clear"></div>
                        </div>
